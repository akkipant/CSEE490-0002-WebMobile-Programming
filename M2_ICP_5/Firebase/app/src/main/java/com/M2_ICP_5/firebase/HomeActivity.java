...
public class HomeActivity extends AppCompatActivity {
    ...
    private Button btnLogout, delName, delPhone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        delName = (Button) findViewById(R.id.btn_delete_usr);
        delPhone = (Button) findViewById(R.id.btn_delete_phone);
